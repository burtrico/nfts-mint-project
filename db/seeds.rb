...
nft_contract1 = NftContract.create(user: user1, contract_type: "non-funglible", contract_address: "1r6c8ixn71xnfv8ed83fg85mskof6i3fjso6sx0s2l", 
      collection_name: "Snuggly Snufkins", name: null, image_url: null, drop_date: "10/21/2021 12:00", price_mint: 0.2, 
...
nft1 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user1.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 1, last_sale: 0.5, num_sales: 1,
...
nft2 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user3.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 1.5, last_sale: 0.6, num_sales: 2,
      description: nft_contract1.description, token_metadata: nft_contract1.token_metadata)
...
nft3 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user5.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 0.9, last_sale: 0.3, num_sales: 1,
      description: nft_contract1.description, token_metadata: nft_contract1.token_metadata)
...
nft4 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user4.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 2, last_sale: 0.75, num_sales: 2,
      description: nft_contract1.description, token_metadata: nft_contract1.token_metadata)
...
nft5 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user6.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 1, last_sale: 0.3, num_sales: 1,
      description: nft_contract1.description, token_metadata: nft_contract1.token_metadata)
...
nft6 = Nft.create(nft_contract_id: nft_contract1.id, user_id: user2.id, collection_name: nft_contract1.collection_name,
      ...
      background_color: null, created_date: "10/21/2021 12:00", price_current: 3, last_sale: 1, num_sales: 3,
      description: nft_contract1.description, token_metadata: nft_contract1.token_metadata)
