...
nft_contract1 = NftContract.create(user: user1, contract_type: "non-funglible", contract_address: "1r6c8ixn71xnfv8ed83fg85mskof6i3fjso6sx0s2l", 
...
nft_contract2 = NftContract.create(user: user1, contract_type: "non-funglible", contract_address: "w0qc8ixn71xnfv8ed83fg35mskof6i3fjso6sx0sd4", 
...
nft_contract3 = NftContract.create(user: user2, contract_type: "non-funglible", contract_address: "9w3l8ixn71xnfv8ed83fg35mskof6i3fjso6sx4k2n", 
...
nft_contract4 = NftContract.create(user: user3, contract_type: "non-funglible", contract_address: "6hw8jlx171xnfv8ed83fg35mskof6i3fjso8m3d0k5", 
...
nft1 = Nft.create(nft_contract: nft_contract1, user: user1, collection_name: nft_contract1.collection_name,
...
nft2 = Nft.create(nft_contract: nft_contract1, user: user6, collection_name: nft_contract1.collection_name,
...
nft3 = Nft.create(nft_contract: nft_contract1, user: user5, collection_name: nft_contract1.collection_name,
...
nft4 = Nft.create(nft_contract: nft_contract1, user: user4, collection_name: nft_contract1.collection_name,
...
nft5 = Nft.create(nft_contract: nft_contract1, user: user3, collection_name: nft_contract1.collection_name,
...
nft6 = Nft.create(nft_contract: nft_contract1, user: user1, collection_name: nft_contract1.collection_name,
...
# --------------------
      ...
      nft7 = Nft.create(nft_contract: nft_contract2, user: user2, collection_name: nft_contract2.collection_name,
      ...
      nft8 = Nft.create(nft_contract: nft_contract2, user: user3, collection_name: nft_contract2.collection_name,
      ...
      nft9 = Nft.create(nft_contract: nft_contract2, user: user4, collection_name: nft_contract2.collection_name,
      ...
      nft10 = Nft.create(nft_contract: nft_contract2, user: user5, collection_name: nft_contract2.collection_name,
      ...
      nft11 = Nft.create(nft_contract: nft_contract2, user: user6, collection_name: nft_contract2.collection_name,
      ...
      nft12 = Nft.create(nft_contract: nft_contract2, user: user2, collection_name: nft_contract2.collection_name,
...
# --------------------
      ...
      nft13 = Nft.create(nft_contract: nft_contract4, user: user6, collection_name: nft_contract4.collection_name,
      ...
      nft14 = Nft.create(nft_contract: nft_contract4, user: user6, collection_name: nft_contract4.collection_name,
